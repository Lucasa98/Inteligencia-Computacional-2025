...
class Evol:
    def __init__(self,
                 ...
                 stop_fun: Callable[[np.ndarray[np.uint8]], bool] = None,
                 max_gen: int = 20,
                 poblacion: int = 100,
                 progenitores: int = 10,
                 precision: int = 8,
        ...
        Args:
            ...
            stop_fun (Callable[[np.ndarray[np.uint8]], bool]): funcion que decide si parar
    ...
    def evolve(self) -> np.ndarray[float]:
        ...
        for _ in range(self.max_gen):
            ...
            # TODO: agregar condicion de parada
            # self.stop(poblacion, fit)
